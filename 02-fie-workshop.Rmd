...
Workshop conducted at the 2019 Frontiers in Education Conference (2019 October) in Cincinnati, OH. 
...
- [Preface](#midfield-workshops) for an introduction to MIDFIELD and the workshop facilitators. 
- [Getting started](#getting-started) for pre-workshop software installation instructions---assuming you plan on using your own laptop. 
...
Workshop slides can be viewed on Speaker Deck (to be posted after the workshop). 
