...
htmltools::img(src = knitr::include_graphics("images/logo-R.png"), 
        alt    = "logo", 
        style  = "left:0px; padding:5px;", 
        height = "110px")
htmltools::img(src = knitr::include_graphics("images/logo-RStudio.png"), 
        alt    = "logo", 
        style  = "left:0px; padding:5px;", 
        height = "110px")
```
...
```{r echo = FALSE}
htmltools::img(src = knitr::include_graphics("images/rstudio-packages.png"), 
...
Alternatively (for future reference), if you prefer using thea command-line, you can install a CRAN package (or a vector of packages) by typing  `install.packages()` in the Console, for example, 

```r
install.packages(pkgs = c("tidyverse", "devtools"))
```

Some packages are archived in a repoistory other than CRAN, GitHub being a current favorite. For such packages, we use `install_github()` from the devtools package in this form, 
...
```{r echo = FALSE}
opts_chunk$set(echo = TRUE)
htmltools::img(src = knitr::include_graphics("images/logo-midfieldr.png"), 
        alt    = "logo", 
        style  = "left:0px; padding:5px;", 
        height = "110px")
htmltools::img(src = knitr::include_graphics("images/logo-midfielddata.png"), 
        alt    = "logo", 
        style  = "left:0px; padding:5px;", 
        height = "110px")
```
...
```{r echo = FALSE}
htmltools::img(src = knitr::include_graphics("images/rstudio-console.png"), 
...
```{r echo = FALSE}
htmltools::img(src = knitr::include_graphics("images/midfieldr-help-page.png"), 
        alt   = "rstudio console pane", 
        width = "700px")
```
...
```{r echo = FALSE}
htmltools::img(src = knitr::include_graphics("images/rstudio-new-project.png"), 
...
```{r echo = FALSE}
htmltools::img(src = knitr::include_graphics("images/rstudio-new-folder.png"), 
