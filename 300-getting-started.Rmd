...
```{r echo = FALSE}
htmltools::img(src = knitr::include_graphics("images/midfielddata-help-page.png"), 
...
```{r echo = FALSE}
htmltools::img(src = knitr::include_graphics("images/package-recent-versions-1.png"), 
